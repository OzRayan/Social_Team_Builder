...
urlpatterns = [
    ...
    # url(r'profile/avatar/rotate_left/$', views.RotateLeftView.as_view(),
    #     name='rotate_avatar_left'),
    # url(r'profile/avatar/flip_up/$', views.FlipUpView.as_view(),
    #     name='flip_avatar_up'),
    # url(r'profile/avatar/flip_side/$', views.FlipSideView.as_view(),
    #     name='flip_avatar_side'),
